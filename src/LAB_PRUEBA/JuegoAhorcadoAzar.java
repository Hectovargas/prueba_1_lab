...
public final class JuegoAhorcadoAzar extends JuegoAhorcadoBase {
    ...
    public String inicializarPalabraSecreta() {
        palabrasPosibles.add("palabra");
        palabrasPosibles.add("estudiante");
        palabrasPosibles.add("profesor");
        palabrasPosibles.add("programar");
        palabrasPosibles.add("ensalada");
        palabrasPosibles.add("ilustracion");
        palabrasPosibles.add("Lapicero");
        palabrasPosibles.add("hemisferi");
        palabrasPosibles.add("ferrocarril");
    ...
    public String actualizarPalabraActual(char letra) {
        ...
        return palabraActual = nuevaPalabra.toString();
    }
